...
% --------------------------------------------Read SYNOP---------------------------------------------------------- 
   ...
   met_all(11,:) = datenum(met_all(2,:), met_all(3,:), met_all(4,:), met_all(5,:), met_all(6,:), met_all(7,:));
...
% --------------------------------------------Read GPS_IN--------------------------------------------------------- 
   ...
   gps_all(12,:) = datenum(gps_all(2,:), gps_all(3,:), gps_all(4,:), gps_all(5,:), gps_all(6,:), gps_all(7,:));
...
% --------------------------------------------Datetime matching---------------------------------------------------
   ...
   for l=1:s6
     for ll=1:s8
      if (gps(1,l) == met(1,ll))   
      gps_met=[gps(1,l); gps(2,l);  met(2,ll); met(3,ll); ];
